...
## 1. Objetivo
Definir las reglas obligatorias para que un agente (o revisor automatizado) evalúe el cumplimiento técnico del desarrollo en Sistemas Abiertos, tomando como base la sección 7 de [instructions\requirements.md](instructions\requirements.md).
