...
## 1. Contexto
Este documento define los requerimientos para el desarrollo en Sistemas Abiertos con base en el JSON de conciliación generado desde IBM i y documentado en `requirements.md`.
